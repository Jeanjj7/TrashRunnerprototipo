...
def desenhar_tela_inicial():
    ...
    logo_unifafire = pygame.image.load("unifafire-curvas-azul-vertical-300x283.png").convert_alpha()
...
while True:
    ...
    if estado_jogo == TELA_INICIAL:
        ...
        # Fonte de informações na tela (pontuação e distância) com nova paleta
